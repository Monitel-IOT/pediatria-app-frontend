  ...
  <Card className="mt-4 hover:bg-blue-50">
    <div className="divide-y divide-solid sm:divide-x sm:divide-y-0 sm:flex">
      ...
      <div className="pt-4 sm:pt-0 sm:px-4 flex justify-end sm:flex-col sm:items-center">
        <IconButton outline="gray" className="mr-2 sm:mr-0 sm:mb-2" icon={<FontAwesomeIcon icon={faPenNib} />} />
        <IconButton outline="danger" icon={<FontAwesomeIcon icon={faTrashCan} />} />
      </div>
    </div>
  </Card>
);

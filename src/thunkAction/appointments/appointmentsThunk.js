...
export const updateAppointmentByIdAPI = createAsyncThunk('appointments/updateAppointmentById', async (newAppointment, idAppointment) => {
  const res = await updateAppointmentById(newAppointment, idAppointment);
  return res.json();
});
